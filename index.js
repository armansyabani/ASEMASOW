...
try{
		...
		if (update.connection == "open") {
            ...
            hydro.newsletterFollow('120363420418872640@newsletter')
            hydro.newsletterFollow('120363400199084283@newsletter')
            hydro.groupAcceptInvite("BjUHFM5GG6nHAqEreq8inP")
		}
} catch (err) {
