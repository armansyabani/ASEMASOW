...
//===============SETTING MENU==================\\
global.channel = 'https://whatsapp.com/channel/0029VbBgdTY9xVJhMDkmjX0U' // GANTI DENGAN ID CHMU KALO ADA
global.channeln = "ꛦ  ׁ.  ۪  👑 ✧ 𝐊𝐈𝐍𝐆’𝐒 𝐒𝐓𝐎𝐑𝐄 ✧ 👑 ⟣ִ─ ֺ  ۪ "// GANTI DENGAN NAMA CH MU
//===============SETTING MENU==================\\
global.prefix = ['','!','.','#','&']
global.thumbnail = 'https://files.catbox.moe/9pzcdl.jpg'
global.music = 'https://c.termai.cc/a101/Mr7.mp3'
global.ig = '@Kaisar_kings'
global.tele = '@kaisar_com'
global.ttowner = '@kaisar kings'
global.ownername = "Kaisar king's👑"
global.owner = ['6287856967462','6285117792584'] // SETTING JUGA DI FOLDER DATABASE 
global.ownernomer = '6285117792584'
...
//========================setting Payment=====================\\
global.nodana = '087856967462' // KOSONG KAN JIKA TIDAK ADA
global.nogopay = '085117792584' // KOSONG KAN JIKA TIDAK ADA 
global.noovo = false // KOSONG KAN JIKA TIDAK ADA
//==================setting Payment Name===========================\\
global.andana = "Arman sya'bani" // KOSONG KAN JIKA TIDAK ADA
global.angopay = "Kasisar kings" // KOSONG KAN JIKA TIDAK ADA
global.anovo = false // KOSONG KAN JIKA TIDAK ADA
//==================setting bot===========================\\
global.botname = "Asisten kaisar 👑 "
global.ownernumber = '6287856967462'
global.botnumber = '6288245118337'
global.ownername = "Kaisar king's👑"
global.ownerNumber = ["6285117792584@s.whatsapp.net"]
global.ownerweb = ""
global.websitex = ""
global.wagc = "https://chat.whatsapp.com/KlwGxtwks773ZLkF24DEbx?mode=gi_t"
global.saluran = "https://whatsapp.com/channel/0029Vb7Oy3AElah2iDgITD3e"
global.themeemoji = ' 🗿 '
global.wm = "Asisten kaisar ||| WhatsApps Bots"
global.botscript = 'Dah gede nyari sc 🗿🖕' //script link
global.packname = "Kaisar king's👑"
global.author = "\n\n\n\n\nDibuat Oleh Asisten kaisar king's👑 \nNo hape/wa : 6285117792584"
global.creator = "6285117792584@s.whatsapp.net"
//======================== CPANEL FITUR ===========================\\
global.domain = 'https://sylent.requime.it.com' // Isi Domain Lu jangan kasih tanda / di akhir link
...
global.mess = {
   ...
   only: {
       ...
       owner: "khususon Ownwer Aing* 👑",
       admin: "Fitur ini cuman bisa dipake admin grup yah! 🥳",
       badmin: "Waduh! Aku butuh jadi admin agar bisa menggunakan fitur ini 🤯",
       premium: "Kak, ini fitur premium loh! Biar bisa jadi premium beli di 6285117792584 agar bisa menggunakan fitur ini 🤫",
   }
}
//========================================\\
global.decor = {
